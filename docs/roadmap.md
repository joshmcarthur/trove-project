...
New users should start with [Try in a day](./getting-started/try-in-a-day.md), then
...
| Records layer (apply/delete) | Supported | §3, §4, §9 | [records](./planning/records.md) | `internal/records` |
| References / link / unlink | Supported | §3 | [references](./planning/references.md) | `internal/records` |
| Deferred capture / classify | Superseded | §3, §6 | [records](./planning/records.md) | — |
...
| Type catalog | Supported | §3, §8 | [type-catalog](./planning/type-catalog.md) | `internal/types` |
| CLI command registration | Supported | §8 | [cli-commands](./planning/cli-commands.md) | `internal/modules` + `cmd/trove` |
| Type introspection (CLI + MCP) | Supported | §3, §8 | [type-introspection](./planning/type-introspection.md) | `modules/type-catalog` |
...
| AT Protocol bridge (pull/push allowlists) | Later | §8 | [atproto-bridge](./planning/atproto-bridge.md) | `modules/atproto-bridge` |
| AT Protocol PDS module (single-user federation) | Later | §8 | [atproto-pds](./planning/atproto-pds.md) | `modules/atproto-pds` |
