...
const (
	CoreServices_RecordWrite_FullMethodName            = "/trove.v1.CoreServices/RecordWrite"
...
type CoreServicesClient interface {
	RecordWrite(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResponse, error)
...
func (c *coreServicesClient) RecordWrite(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WriteResponse)
	err := c.cc.Invoke(ctx, CoreServices_RecordWrite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServicesServer interface {
	RecordWrite(context.Context, *WriteRequest) (*WriteResponse, error)
...
func (UnimplementedCoreServicesServer) RecordWrite(context.Context, *WriteRequest) (*WriteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RecordWrite not implemented")
}
...
func _CoreServices_RecordWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServicesServer).RecordWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoreServices_RecordWrite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServicesServer).RecordWrite(ctx, req.(*WriteRequest))
	}
...
var CoreServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RecordWrite",
			Handler:    _CoreServices_RecordWrite_Handler,
		},
		{
			MethodName: "BlobPut",
