...
func (UnimplementedCoreServicesServer) AppendRevision(context.Context, *AppendRevisionRequest) (*AppendRevisionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AppendRevision not implemented")
}
...
func (UnimplementedCoreServicesServer) SearchRevisions(context.Context, *SearchRevisionsRequest) (*SearchRevisionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchRevisions not implemented")
}
func (UnimplementedCoreServicesServer) GetRevisionsByType(context.Context, *GetRevisionsByTypeRequest) (*SearchRevisionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRevisionsByType not implemented")
}
